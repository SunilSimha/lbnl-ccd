...
#
setup_keywords['name'] = 'LBNL_CCD'
setup_keywords['description'] = 'Python code to analyze data from a 4kx4k LBNL CCD'
setup_keywords['author'] = 'UCO/LICK community'
setup_keywords['author_email'] = 'shassans@ucsc.edu'
setup_keywords['license'] = ''
setup_keywords['url'] = 'https://github.com/SunilSimha/lbnl-ccd'
